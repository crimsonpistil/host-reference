...
const CMS_TEMPLATES = {
  ...
  'T1562.001': { title:'T1562.001 - Disable or Modify Tools', body:`## TAG - DEFENSE EVASION\n### Technique: Disable or Modify Tools, T1562.001 [LINUX]\n- Time:\n- Host:\n- User / UID (auid):\n- Target Type: (security agent / EDR / AV / cloud agent / SELinux / AppArmor)\n- Agent: (Falco / Wazuh / osquery / ClamAV / falcon-sensor / aegis-AliYunDun / YunJing)\n- Method: (systemctl stop/disable/mask / kill / pkill / uninstall script / package remove)\n- Cloud-Agent Uninstall (Alibaba/Tencent) - crypto-crew TTP? (Y/N):\n- Install Dir Present but Process Absent (uninstalled)? (Y/N):\n- MAC Action: (setenforce 0 / SELINUX=disabled / aa-teardown / aa-complain / GRUB selinux=0):\n- SELinux getenforce / AppArmor aa-status Now:\n- External Console Heartbeat Gap (agent-down alert)? (Y/N):\n- Layered Sensor Witnessed the Disable (Y/N):\n- Auditd Key Alert: (svc_change / kill_signal / selinux_config / setenforce_exec)\n\nNotes:` },
